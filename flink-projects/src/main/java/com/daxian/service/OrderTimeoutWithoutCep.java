 ...
 * Package: com.daxian.orderpay_detect
 * Version: 1.0
 * <p>
 * Created by wushengran on 2020/11/18 11:27
 */

import com.daxian.orderpay_detect.beans.OrderEvent;
import com.daxian.orderpay_detect.beans.OrderResult;
...
public class OrderTimeoutWithoutCep {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 读取数据并转换成POJO类型
        URL resource = com.daxian.orderpay_detect.OrderPayTimeout.class.getResource("/OrderLog.csv");
